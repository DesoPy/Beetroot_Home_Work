from mymod import count_chars, count_lines, test
"""
Task 3
Basics, import, work with os module

Write a program that counts lines and characters
in a file (similar to `wc` Unix-utility, for additional info about it
...
count_lines(name) function that reads an input file
and counts the number of lines in it (hint: file.readlines() does most of the work for you, and `len` does the rest)
...
if you’re feeling ambitious,you may be able to improve this
by passing an open file object into the two count functions (hint: file.seek(0) is a file rewind).
"""

# name = '001.txt' -- file for example

print('Function count_chars imported from mymod.py:')

count_chars('001.txt')

print('#'*30)
print('Function count_lines imported from mymod.py:')
