...
# O(n) - one cycle is executed n times
...
# O(1) - one action is performed linearly
...
# O(n^2) - one cycle is nested within another (n * n = n^2)
...
# O(log n) - a search algorithm that is represented as a logarithm
